...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:variable name="page-title">XProc 3.0 Atomic Steps: an index</xsl:variable>
...
button.cp { float: right }
   ...
   <xsl:template name="lede">
      ...
      <section class="introduction">
         ...
         <p><i>Not</i> included are the core compound steps, <code>for-each</code>, <code>try/catch</code> etc.</p>
