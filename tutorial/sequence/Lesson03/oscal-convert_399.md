...
> *Warning:* this Markdown file will be rewritten under continuous deployment (CD): edit the source in [/tutorial/source/oscal-convert/oscal-convert_399_src.html](../../../tutorial/source/oscal-convert/oscal-convert_399_src.html).
> 
> Save this file elsewhere to create a persistent copy (for example, for purposes of annotation).

# 399: XProc in more depth
...
See coverage of [XProc, XML and XDM (the XML                   Data Model)](../unpack/unpack_399.md) in the prior lesson unit for a link to the schema for XProc.
